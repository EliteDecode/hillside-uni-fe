  ...
  return (
    <Box
      ...
      <Box className="container">
        <Title title="Adverts" subtitle="HUST" />
        <div className="bg-gray-100 min-h-screen p-4">
          <main className="bg-white p-8 rounded shadow">
            <header className=" mb-8">
              ...
              <p>
                Join us at Hillside University of Science and Technology,
                Okemesi – Ekiti State
              </p>
            </header>
            {/* Content Section */}
            <section className="mb-8">
              ...
              <p>
                A First-in-Class entrepreneurial University of Health Sciences
                and Technology, Hillside is purpose-built on a
                sustainability-driven industry-inspired curriculum and operating
                structure to bridge an insatiable gaping deficit of a famished
                Nigerian mega healthcare services professionals and technology
                consumer market. Its mission is to maximize the potential of its
                learners and to rebuild the nation’s economy and society through
                an accelerated demand-driven manpower development program based
                on innovation, integrated applied learning and research.
                <br />
                <br />
                ...
                innovation-driven global talent professionals and teachers
                passioned by the quintuple Hillside service values of
                Competence; Character; Courage; Commitment; Cooperation; to fill
                the below listed full-time positions:
              </p>
            ...
            <section className="mb-8">
              <div className="bg-white p-4 rounded shadow mb-8">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-4">
                    <li className="text-[15px]">
                      a) Director of Academic Planning (Senior Lecturer and
                      above)
                    </li>
                    {/* Include the subcategories and their details */}
                    <li className="text-[15px]">
                      b) Academic Planning Officers
                    </li>
                    {/* Include the subcategories and their details */}
                  </ul>
                </div>
            ...
            <section className="mb-8">
              <div className="bg-white p-4 rounded shadow mb-8">
                ...
                <div className="mb-4">
                  ...
                  <ul className="list-disc pl-4">
                    <li>
                      a. Administrative Officers & Confidential Secretaries
                    </li>
                    <li>b. Accountants</li>
                    <li>c. Procurement, Stores and Quality Control Officers</li>
                    <li>d. Library Officers & Archivists</li>
                    <li>
                      e. Security & Intelligence Officers (Uniformed; Mufti;
                      Cyber)
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <ul className="list-disc pl-4">
                    ...
                    <li>
                      d. Health Technologists & Allied Medical Professionals
                      (All Specializations)
                    </li>
                  </ul>
                </div>
            ...
            <section className="mb-8">
              <div className="bg-white p-4 rounded shadow mb-8">
                ...
                <p>
                  ...
                  respective candidate should prepare his or her application,
                  CV, all credentials, and attachments in a single PDF file and
                  forward with a cover letter to{" "}
                  <a href="mailto:careers@hust.edu.ng">careers@hust.edu.ng</a>.
                  The subject of the document should be marked with the relevant
                ...
                <p>
                  ...
                  references will greatly expedite the candidate evaluation
                  process and should not be unreasonably delayed. No candidate
                  will be enlisted on the Payroll whose references have not been
                  received on file.
                </p>
          ...
          <a
            href={require("../../assets/vacancy.pdf")}
            download
            className="mt-3">
            <Button
              size="small"
